...
SECRET_KEY = 'django-insecure-6su#i@l&44d64b-y(i%+-1+93+-j8a7pb_7w^afv+p!$qt#6qy'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'studygenie_db',
        'USER': 'root',
        'PASSWORD': 'Sujay@vit123',
        'HOST': 'localhost',
        'PORT': '3306',
    }
}

# In Production, Render provides a DATABASE_URL. Override local settings.
